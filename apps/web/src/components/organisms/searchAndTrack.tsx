...
import { ListChecks, Trash, X } from "lucide-react";
...
export const SearchAndAddFood = ({ currentUser, mealType }: { currentUser: UserInterface; mealType: MealType }) => {
	...
	return (
		<div className="flex flex-col justify-between h-full">
			{/*<p className="text-lg font-bold text-secondary-foreground text-center">Had your {mealType}?</p>*/}
			<div className="flex flex-col gap-4">
				<AutoComplete
					...
					isLoading={isLoading}
					placeholder={`What was your ${mealType}?`}
				...
				<div className="w-full h-[330px] overflow-auto">
					{selectedItems.length > 0 && (
						<Accordion
							type="single"
							collapsible
							className="w-full border px-2 rounded-md overflow-auto"
							value={expandedItem}
					...
					<AccordionItem value="total-consumed">
						...
						<AccordionContent className="flex flex-col items-center gap-2">
							...
							<div className="self-end w-max flex align-center gap-2">
								...
								<Button
									size={BUTTON_SIZES.SMALL}
									disabled={consumedInfo.length === 0}
